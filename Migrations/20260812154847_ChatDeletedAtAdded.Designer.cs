...
namespace SocialMediaBackend.Migrations
{
    ...
    [Migration("20260812154847_ChatDeletedAtAdded")]
    partial class ChatDeletedAtAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SocialMediaBackend.Data.Entities.Chat", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("SocialMediaBackend.Data.Entities.Message", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SocialMediaBackend.Data.Entities.Chat", b =>
                {
                    b.HasOne("SocialMediaBackend.Data.Entities.User", "User1")
                        .WithMany()
                        .HasForeignKey("User1Id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SocialMediaBackend.Data.Entities.User", "User2")
                        .WithMany()
            ...
            modelBuilder.Entity("SocialMediaBackend.Data.Entities.Message", b =>
                {
                    b.HasOne("SocialMediaBackend.Data.Entities.Chat", "Chat")
                        .WithMany("Messages")
                        .HasForeignKey("ChatId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SocialMediaBackend.Data.Entities.User", "Sender")
                        .WithMany()
