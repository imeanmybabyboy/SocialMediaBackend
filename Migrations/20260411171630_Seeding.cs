...
namespace SocialMediaBackend.Migrations
{
    ...
    public partial class Seeding : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Posts",
                columns: new[] { "Id", "Bio", "ImageUrl", "LikesQnt", "SharesQnt", "Title", "UserId" },
                values: new object[,]
                {
                    { new Guid("a1111111-1111-1111-1111-111111111111"), "This is the very first post in the system.", null, 10, 2, "Welcome Post", new Guid("c1d2e3f4-5678-4abc-9def-1234567890ab") },
                    { new Guid("a2222222-2222-2222-2222-222222222222"), "Sharing some daily reflections.", null, 5, 1, "Daily Thoughts", new Guid("d2e3f4a5-6789-4bcd-8efa-2345678901bc") }
                });

            migrationBuilder.InsertData(
                table: "Posts",
                columns: new[] { "Id", "Bio", "ImageUrl", "LikesQnt", "Title", "UserId" },
                values: new object[] { new Guid("a3333333-3333-3333-3333-333333333333"), "Hello everyone, glad to join!", null, 7, "Maria’s First Post", new Guid("e3f4a5b6-7890-4cde-9fab-3456789012cd") });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("a4444444-4444-4444-4444-444444444444"), "Quick update from Alex.", null, 3, 1, "Alex’s Update", new Guid("f4a5b6c7-8901-4def-9abc-4567890123de") },
                    { new Guid("a5555555-5555-5555-5555-555555555555"), "Excited to share my first post.", null, 12, 4, "Sofia’s Post", new Guid("01234567-89ab-4cde-9f01-234567890abc") },
                    { new Guid("a6666666-6666-6666-6666-666666666666"), "Mike shares his ideas.", null, 8, 2, "Mike’s Thoughts", new Guid("12345678-9abc-4def-9012-345678901bcd") },
                    { new Guid("a7777777-7777-7777-7777-777777777777"), "Olga writes about her day.", null, 15, 5, "Olga’s Story", new Guid("23456789-abcd-4ef0-9123-45678901cdef") },
                    { new Guid("a8888888-8888-8888-8888-888888888888"), "Ivan shares his music journey.", null, 20, 7, "Ivan’s Rock", new Guid("3456789a-bcde-4f01-9234-5678901def01") },
                    { new Guid("a9999999-9999-9999-9999-999999999999"), "Important system update.", null, 30, 10, "Admin’s Announcement", new Guid("c1d2e3f4-5678-4abc-9def-1234567890ab") },
                    { new Guid("b1111111-1111-1111-1111-111111111111"), "Sharing my travel experience.", null, 18, 6, "John’s Travel", new Guid("d2e3f4a5-6789-4bcd-8efa-2345678901bc") },
                    { new Guid("b2222222-2222-2222-2222-222222222222"), "Cooking tips and tricks.", null, 25, 9, "Maria’s Recipe", new Guid("e3f4a5b6-7890-4cde-9fab-3456789012cd") },
                    { new Guid("b3333333-3333-3333-3333-333333333333"), "Alex shares coding tips.", null, 14, 3, "Alex’s Coding", new Guid("f4a5b6c7-8901-4def-9abc-4567890123de") },
                    { new Guid("b4444444-4444-4444-4444-444444444444"), "My latest painting.", null, 22, 8, "Sofia’s Art", new Guid("01234567-89ab-4cde-9f01-234567890abc") },
                    { new Guid("b5555555-5555-5555-5555-555555555555"), "Workout routines.", null, 16, 5, "Mike’s Fitness", new Guid("12345678-9abc-4def-9012-345678901bcd") },
                    { new Guid("b6666666-6666-6666-6666-666666666666"), "Reviewing my favorite book.", null, 19, 7, "Olga’s Book Review", new Guid("23456789-abcd-4ef0-9123-45678901cdef") },
                    { new Guid("b7777777-7777-7777-7777-777777777777"), "Football match highlights.", null, 28, 11, "Ivan’s Sports", new Guid("3456789a-bcde-4f01-9234-5678901def01") },
                    { new Guid("b8888888-8888-8888-8888-888888888888"), "System usage tips.", null, 12, 4, "Admin’s Tips", new Guid("c1d2e3f4-5678-4abc-9def-1234567890ab") },
                    { new Guid("b9999999-9999-9999-9999-999999999999"), "Sharing my playlist.", null, 21, 8, "John’s Music", new Guid("d2e3f4a5-6789-4bcd-8efa-2345678901bc") },
                    { new Guid("c1111111-1111-1111-1111-111111111111"), "Trip to the mountains.", null, 17, 6, "Maria’s Travel", new Guid("e3f4a5b6-7890-4cde-9fab-3456789012cd") },
                    { new Guid("c2222222-2222-2222-2222-222222222222"), "Latest game review.", null, 24, 9, "Alex’s Gaming", new Guid("f4a5b6c7-8901-4def-9abc-4567890123de") },
                    { new Guid("c3333333-3333-3333-3333-333333333333"), "Trip to the seaside.", null, 13, 4, "Sofia’s Travel", new Guid("01234567-89ab-4cde-9f01-234567890abc") },
                    { new Guid("c4444444-4444-4444-4444-444444444444"), "Learning C# step by step.", null, 9, 3, "Mike’s Coding Journey", new Guid("12345678-9abc-4def-9012-345678901bcd") },
                    { new Guid("c5555555-5555-5555-5555-555555555555"), "My favorite recipes.", null, 27, 12, "Olga’s Cooking", new Guid("23456789-abcd-4ef0-9123-45678901cdef") },
                    { new Guid("c6666666-6666-6666-6666-666666666666"), "Exploring the forest trails.", null, 19, 6, "Ivan’s Hiking", new Guid("3456789a-bcde-4f01-9234-5678901def01") },
                    { new Guid("c7777777-7777-7777-7777-777777777777"), "How to keep your account safe.", null, 33, 14, "Admin’s Security Tips", new Guid("c1d2e3f4-5678-4abc-9def-1234567890ab") },
                    { new Guid("c8888888-8888-8888-8888-888888888888"), "Capturing the sunset.", null, 22, 7, "John’s Photography", new Guid("d2e3f4a5-6789-4bcd-8efa-2345678901bc") }
                });
